...
```typescript
import { pipe, fromEvent, interval } from "@cereb/core";
import { buffer } from "@cereb/core";
...
import { bufferTime } from "@cereb/core";
...
```typescript
import { pipe, timer } from "@cereb/core";
import { bufferWhen } from "@cereb/core";
